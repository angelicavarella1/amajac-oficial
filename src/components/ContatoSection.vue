        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
          ...
          <ul class="space-y-4">
            ...
            <li v-if="configuracoesStore.contatoTelefone" class="flex items-start">
              <i class="fas fa-phone-alt text-amajac-600 mt-1 mr-3"></i>
              <div>
            ...
            <li v-if="configuracoesStore.contatoEmail" class="flex items-start">
              <i class="fas fa-envelope text-amajac-600 mt-1 mr-3"></i>
              <div>
            ...
            <li v-if="configuracoesStore.contatoEndereco" class="flex items-start">
              <i class="fas fa-map-marker-alt text-amajac-600 mt-1 mr-3"></i>
              <div>
            ...
            <li v-if="configuracoesStore.contatoHorarioFuncionamento" class="flex items-start">
              <i class="fas fa-clock text-amajac-600 mt-1 mr-3"></i>
              <div>
...
import { useConfiguracoesStore } from '@/stores/configuracoes'; // Ajuste o caminho se necessário
