...
<template>
  <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between mb-2">
          ...
          <i class="fas fa-database" :class="getCorIcone(uso.disco.percentual)"></i>
        </div>
      ...
      <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between mb-2">
          ...
          <i class="fas fa-network-wired" :class="getCorIcone(uso.bandwidth.percentual)"></i>
        </div>
      ...
      <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between mb-2">
          ...
          <i class="fas fa-table" :class="getCorIcone(uso.linhas.percentual)"></i>
        </div>
      ...
      <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between mb-2">
          ...
          <i class="fas fa-microchip" :class="getCorIcone(uso.cpu.percentual)"></i>
        </div>
    ...
    <div class="mt-6 flex justify-between items-center">
      ...
      >
        <i class="fas fa-sync-alt" :class="{ 'animate-spin': carregando }"></i>
