  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="image-wrapper w-full h-full">
                  ...
                  <div v-else-if="logoState.loading" class="placeholder animate-pulse w-full h-full flex items-center justify-center bg-gray-100">
                    <div class="text-center">
                      <i class="fas fa-store text-2xl text-gray-400 mb-2"/>
                  ...
                  <div v-else class="w-full h-full flex items-center justify-center bg-gray-100">
                    <i class="fas fa-store text-4xl text-primary-600"/>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="p-8">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                  ...
                  >
                    <div class="image-wrapper w-full h-full">
                      ...
                      <div v-else-if="imagem.imageState.loading" class="placeholder animate-pulse w-full h-full flex items-center justify-center">
                        <i class="fas fa-image text-gray-400"/>
                      </div>
              ...
              <!-- Contato -->
              <section>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Informacoes de Contato</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div v-if="parceiro.endereco" class="flex items-start gap-3">
                    ...
                    <div>
                      <h3 class="font-semibold text-gray-900 dark:text-white">Endereco</h3>
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                      {{ parceiro.ativo ? 'Aceitando clientes' : 'Temporariamente indisponivel' }}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div v-if="parceiro.etiquetas && parceiro.etiquetas.length" class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Servicos & Caracteristicas</h3>
      ...
      <div v-else class="text-center py-12">
        ...
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Parceiro nao encontrado</h2>
        <p class="text-gray-600 dark:text-gray-400">O parceiro que voce esta procurando nao existe ou foi removido.</p>
      </div>
    </main>
  </div>
</template>
...
function formatData(dataString) {
  ...
  try {
    ...
    if (isNaN(data.getTime())) return 'Data invalida'
...
function abrirGaleria(index) {
  ...
  console.log('Abrir galeria no indice:', index)
}
</script>
