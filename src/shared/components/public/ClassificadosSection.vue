  ...
  <section id="classificados" class="py-16 bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-4">
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600 dark:text-gray-400">Servicos e produtos da comunidade</p>
      </div>
      ...
      <div v-else class="text-center py-12">
        <div class="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md mx-auto border border-gray-200 dark:border-gray-700">
          ...
          <p class="text-gray-500 dark:text-gray-400 mb-6">Em breve teremos servicos e produtos da nossa comunidade!</p>
          <button 
...
// CORRECAO: Computeds para processar classificados com useSafeImage reativamente
